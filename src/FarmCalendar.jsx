...
const styles = {
  ...
  dayCell: { background: "#F7F3E9", borderRadius: 8, overflow: "hidden", border: "1px solid #DAD3BE", position: "relative", minHeight: 54 },
  dayCellToday: { border: "1.5px solid #BC6C25" },
  dayNum: { position: "absolute", top: 2, right: 4, fontSize: 9, color: "#6B6355", zIndex: 2 },
  ...
  input: { width: "100%", boxSizing: "border-box", padding: "8px 10px", borderRadius: 8, border: "1px solid #C9C0A8", background: "#FFFFFF", fontSize: 13, fontFamily: "'Tajawal', sans-serif" },
  textarea: { width: "100%", boxSizing: "border-box", padding: "8px 10px", borderRadius: 8, border: "1px solid #C9C0A8", background: "#FFFFFF", fontSize: 13, fontFamily: "'Tajawal', sans-serif", resize: "vertical" },
