...
const translations = {
  ar: {
    ...
    morningLegend: "صباحي: من الساعة 10 صباحاً حتى 9 مساءً",
    eveningLegend: "سهرة: من الساعة 10 مساءً حتى 8 صباحاً",
    morning: "صباحي",
    evening: "سهرة",
    available: "متاح",
    booked: "محجوز",
  ...
  en: {
    ...
    morningLegend: "Morning: 10:00 AM – 9:00 PM",
    eveningLegend: "Evening: 10:00 PM – 8:00 AM",
    morning: "Morning",
    evening: "Evening",
    available: "Available",
    booked: "Booked",
